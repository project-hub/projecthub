    ...
    public function run()
    {
        ...
        DB::table('users')->insert(array(
             ...
             array('first_name'=>'David',
                    'last_name'=>'Berry',
                    'company_name'=>'Concourse Auto Salon',
                    'address'=>'2450 Babcock Rd. Suite 138',
                    'city'=>'San Antonio',
                    'state'=>'TX',
                    'zip_code'=>78229,
                    'email'=>'d_berry@gmail.com',
                    'employer'=>1,
                    'content'=>"Concourse Auto Salon offers a wide variety of automotive detailing services. From a simple hand wash and hand waxing to the most comprehensive auto detailing in San Antonio. Our professional and experience auto detailing staff cares for each client and spends the necessary time to bring out the best in every vehicle. Our specialties  include Auto Detailing, Window Tinting, Paint Protection and Vehicle Wraps!",
                    'linkedin_id'=>'',
                    'github'=>'',
                    'website'=>'http://www.concoursautosalon.com/',
                    'image'=>'https://biz.prlog.org/R_Harris/logo.png',
                    'password'=>bcrypt('password')),
